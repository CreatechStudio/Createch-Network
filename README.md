...
版本: 1.18.1-fabric/forge（必选）-optfine（可选）
...
接着，在您的启动器里面选择添加外置登录服务器（HMCL)，并按照上述网站用户中心内的提示完成操作。
...
1. 在纯净生存（Pure Survival）当中，您不可以使用任何游戏外挂,连点器，来获取物资或杀戮其他玩家。
...
本服务器已经支持在线地图查看，您可前往 http://mcmap.createchstudio.com:8100 查看地图，禁止使用此地图插件攻击其他玩家，如被发现将被软封禁（即禁止访问所有在线资源）
...
/setwarp 名称
设立传送点，传送点所有人可见，如果设置错误，请联系管理员删除，如恶意设置节点，将被删除，恕不通知
...
如果遇到上述指令无法使用，请发送标签为BUG的Issue，或发送邮件到 service@createchstuio.com ，我们会尽快与您取得联系
